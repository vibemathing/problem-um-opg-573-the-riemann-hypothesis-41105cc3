...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-573-the-riemann-hypothesis-41105cc3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-573"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-573-the-riemann-hypothesis-41105cc3-v1",
      "problem_contract_sha256": "1508a5c7476066ed6b00848d075bb23f2713047350479b52118f8755f8fbba91",
      "problem_id": "problem:um-opg-573-the-riemann-hypothesis-41105cc3",
      "route_id": "route:um-opg-573-the-riemann-hypothesis-41105cc3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-573-the-riemann-hypothesis-41105cc3-source-fidelity-01",
      "graph_id": "graph:um-opg-573-the-riemann-hypothesis-41105cc3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-573-the-riemann-hypothesis-41105cc3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-573-the-riemann-hypothesis-41105cc3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "The zeroes of the Riemann zeta function that are inside the Critical Strip (i.e. the vertical strip of the complex plane where the real part of the complex variable is in ]0;1[), are actually located on the Critical line ( the vertical line of the complex plane with real part equal to 1/2)"
          },
          "statement_sha256": "ba892cb8fe77532f8b15b96bcf35adda38595fcf1a7fed9d54c5c5ac1b54fd33"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-573-the-riemann-hypothesis-41105cc3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-573-the-riemann-hypothesis-41105cc3-root",
      "route_id": "route:um-opg-573-the-riemann-hypothesis-41105cc3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-573-0339263fdeda",
        "url": "https://www.unsolvedmath.com/problems/OPG-573"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
